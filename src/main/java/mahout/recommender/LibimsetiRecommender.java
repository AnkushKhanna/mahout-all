...
public class LibimsetiRecommender implements Recommender {
  ...
  public LibimsetiRecommender() throws TasteException, IOException {
    this(new FileDataModel(readResourceToTempFile("libimseti/ratings.dat")));
  }
  ...
  public LibimsetiRecommender(DataModel model)
    ...
    this.model = model;
    FastIDSet[] menWomen = GenderRescorer.parseMenWomen(readResourceToTempFile("libimseti/gender.dat"));
    men = menWomen[0];
    women = menWomen[1];
